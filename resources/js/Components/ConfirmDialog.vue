...
const visible = computed(() => uiStore.modals.confirmDelete.visible);
const taskId = computed(() => uiStore.modals.confirmDelete.taskId);

const confirm = () => {
  if (uiStore.modals.confirmDelete.onConfirm) {
    uiStore.modals.confirmDelete.onConfirm();
  }
